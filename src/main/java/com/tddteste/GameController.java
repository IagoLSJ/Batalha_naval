...
public class GameController {
  ...
  public static boolean endGame(Tabuleiro t, String nomeJogador) {
    for (int i = 0; i < 10; i++) {
      for (int j = 0; j < 10; j++) {
        if (t.tabuleiro[i][j] == 1) {
          return false;
  ...
  public void startGame(String playerName1, String playnerName2) {
    Jogador jogador01 = new Jogador(playerName1);
    Jogador jogador02 = new Jogador(playnerName2);
    ...
    while (!endGame(jogador01.tabuleiro, jogador01.nome)
        && !endGame(jogador02.tabuleiro, jogador02.nome)) {
